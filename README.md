...
- To use Interface A (AND lego power function IR) with Lego Blockly you need to upload a "sketch" into an arduino (UNO or Nano preferably OR an ESP32 for BT communication)
	...
	- ARDUINO UNO/NANO:
		...
		- See [folder SketchArduino](SketchArduino) and upload sketch to your Arduino.  Use Lego9750_V2 or the latest Lego9750_PF_UNO_V4 (SOFT PWM) or Lego9750_UNO_V3 (NO PF IR, HW PWM) (V3, V4 support dual protocol (Blockly and Bit Bang for Lego Legacy DOS software), See ESP32 below).
