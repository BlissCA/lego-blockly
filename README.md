...
- To use Interface A (AND lego power function IR) with Lego Blockly you need to upload a "sketch" into an arduino (UNO or Nano preferably OR an ESP32 for BT communication)
	...
	- ESP32 (BLUETOOTH)
		...
		- IMPORTANT: Since the ESP32 GPIO's operate at 3.3v level, you need to use a Voltage Level Shifter (TXS0108E recommended) between GPIO's and Lego Interface A Inputs and Outputs connector pins...
