...
// Register the custom callback right after workspace injection
window.workspace.registerToolboxCategoryCallback('PROCEDURE', (ws) => {
  // 1. Fetch the default procedure blocks generated by Blockly
  const blockList = Blockly.Procedures.flyoutCategory(ws);

  // 2. Append your static return blocks
  blockList.push({
    'kind': 'block',
